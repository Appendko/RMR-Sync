...
// mode.
//
// Item 572 (3ItKeyVavaStage) merges completely normally here like any other
// item -- no exclusion. Its corresponding check (736, 3ChKeyVavaStage) is
// kept in sync purely client-side (lua/share_info.lua's
// checkForVavaStageKeyOwned): whenever a player's own item-572 bit is set,
// by any means, their own game locally sets check 736 to match. The
// Vava-stage teleporter disappearing the moment you own the key is expected,
// correct behavior -- not something this server needs to gate or prevent.
